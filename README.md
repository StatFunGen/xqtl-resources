...
| &nbsp;&nbsp;&nbsp;&nbsp;├─ `/LDSC_reference_data` | —                                 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ `/LD_scores` | Misc. file     | LD reference data (on Synapse)                                                                                   | Anjing Liu                      |Miscellaneous       | LD scores, S-LDSC annotations, munged GWAS data   
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ `/sldsc_annoatations` | Misc. file    | LD reference data (on Synapse)                                                                                   | Anjing Liu                      |Miscellaneous       | LD scores, S-LDSC annotations, munged GWAS data  
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ `/GWAS_munged` | Misc. file     | LD reference data (on Synapse)                                                                                   | Ruixi Li                      |Miscellaneous       | LD scores, S-LDSC annotations, munged GWAS data                                                                | Anjing Liu (except GWAS munged), Ruixi Li (GWAS munged) |
