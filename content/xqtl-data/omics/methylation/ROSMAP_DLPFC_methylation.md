...
- Data Citation : Omics data: [syn3157275](https://www.synapse.org/Synapse:syn3157275); Genetics data: [ng00067](https://dss.niagads.org/datasets/ng00067/)
- Genetics Publication : PMID: 40407102
- PI : David A. Bennett (Rush University Medical Center, Chicago, IL, USA)

## QTL Analysis
QTL analysis for this dataset is documented in [../../qtl/mQTL/ROSMAP_DLPFC_methylation_qtl.md](../../qtl/mQTL/ROSMAP_DLPFC_methylation_qtl.md).
