...
Used proteomics data directly without further QC. For QCs performed on data please refer to `descriptor/omics/proteomics/proteomics/ROSMAP_DLPFC_proteomics.md`
