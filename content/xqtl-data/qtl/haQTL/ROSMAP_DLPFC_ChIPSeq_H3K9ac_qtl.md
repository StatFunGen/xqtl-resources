...
Used h3k9ac readcount data directly without further QC. For QCs performed in Chip-seq and peak calling please refer to `descriptor/omics/histone_ChIPSeq/ROSMAP_DLPFC_ChIPSeq_H3K9ac.md`
